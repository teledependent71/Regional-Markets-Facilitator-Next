...
import booksPageInitialPaths2799dResource from '../../../resources/books-page-initial-paths-2799d'
import booksPageInitialPropsEf869Resource from '../../../resources/books-page-initial-props-ef869'
...
export async function getStaticPaths() {
  const response = await booksPageInitialPaths2799dResource({})
...
export async function getStaticProps(context) {
  try {
    const response = await booksPageInitialPropsEf869Resource({
      ...context?.params,
